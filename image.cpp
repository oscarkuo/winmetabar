...
// Source code adapted from http://faithlife.codes/blog/2008/09/displaying_a_splash_screen_with_c_part_i/
...
HBITMAP LoadPngToHBITMAP(DWORD nId)
{
    HBITMAP hbmpSplash = NULL;

    // load the PNG image data into a stream
    IStream * ipImageStream = CreateStreamOnResource(MAKEINTRESOURCE(nId), L"PNG");
